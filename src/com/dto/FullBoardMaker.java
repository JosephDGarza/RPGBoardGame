...
public class FullBoardMaker {

		public String boardCreation(String divs) {
			divs ="";
			String css ="";
			int i =0;
			...
			pixel += 210;
			query = "select portrait,name,str,hp from EnemyBoard2Dto WHERE id = '"
					+ i + "'";
			...
			while (it.hasNext()) {
				...
				divs += "<div id=\"picture" + i +"\">\r\n" + 
						" " + portrait+ "<div class=\"pic_transform" +i +"\">\r\n" +  
						"\r\n" + 
